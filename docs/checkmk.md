...
## Uptime checks
 [Status check for the Web Service](https://pulmonitor.princeton.edu/staging/check_mk/index.py?start_url=%2Fstaging%2Fcheck_mk%2Fview.py%3Fhost%3Dorcid-staging.princeton.edu%26site%3Dstaging%26view_name%3Dhost)
### The uptime check configuration
  ...
  If you want to see that the system is still down after an hour you need to set the "Throttling of 'Periodic notifications'" to 6 (3 currently) and send every 60
    [staging uptime check](https://pulmonitor.princeton.edu/staging/check_mk/index.py?start_url=%2Fstaging%2Fcheck_mk%2Fwato.py%3Fback_mode%3Dtest_notifications%26edit%3D9%26folder%3D%26mode%3Dnotification_rule_quick_setup%26user%3D)
