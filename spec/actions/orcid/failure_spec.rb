...
RSpec.describe OrcidPrinceton::Actions::Orcid::Failure do
  ...
  it 'works' do
    ...
    # TODO: Why is the message not quite right...
    expect(response.flash.next[:notice]).to eq("Omniauth linking failed Error with Auth (Exception).  Consider linking your account")
  end
end
